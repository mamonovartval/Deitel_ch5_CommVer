...
//int main()
//{
//	int counter = 0; // îáúÿâèòü è èíèöèàïèçèðîâàòü óïðàâïÿàöóþ ïåðåìåííóþ
//
//	while (++counter <= 10) // óñëîâèå ïðîäîëæåíèÿ öèêëà
//		cout << counter << " ";
//				
//	cout << endl; // âûâåñòè ñèìâîë íîâîé ñòðîêè
//	
//	return 0; // óñïåøíîå çààåðøåèèå
//}// êîíåö main
...
/*int main()
{
	int counter = 1; // èíèöèàëèçèðîâàòü ñ÷åò÷èõ
		
	do
	{
		cout << counter << " "; // âûâåñòè ñ÷åò÷èê
		counter++; // óâåëè÷èòü ñ÷åò÷èê
	} while (counter <= 10); // êîíåö do . . . while

	cout << endl; // âûâåñòè íîâóþ ñòðîêó
	return 0;
}*/
...
/*int main()
{
	// ñîçäàòü 06'1.åõò GradeBook
	GradeBook myGradeBook("CS101 C++ Programming");
	
	myGradeBook.displayMessage(); // âûâåñòè ïðèâåòñòâåííîå ñîîáùåíèå
	myGradeBook.inputGrades(); // ïðî÷èòàòü ââîäèìûå îöåíêè
	myGradeBook.displayGradeReport(); // âûâåñòè îò÷åò ïî îöåíêàì
	return 0; // óñïåøíîå çàâåðøåíèå
} // êîíåö main*/
...
/*int main()
{
	int count; // ñ÷åò÷èê, èñïîïüçóåíûé òàêæå ïîñïå âûõîäà èç öèêëà

	for (count = 1; count <= 10; count++) // ïîâòîðèòü 10 ðàç
	{
		if (count == 5) // åñïè count ðàâåí 5,
			continue; // ïðîäîëæèòü öèêë
			//break;çàâåðøèòü öèêë
...
/*int main()
{
	...
	// çàïðîñèòü ââîä ïîëüçîâàòåëÿ
	cout << " Enter two integers in the range 1 -20: ";
	cin >> õ >> ó; // ïðî÷èòàòü çíà÷åíèÿ äëÿ õ è ó
	
	for (int i = 1; i <= ó; i++ )  // ñ÷èòàòü îò 1 äî ó
		{
			for (int j = 1; j <= õ; j++) // ñ÷èòàòü îò 1 äî õ
			cout << '@'; // âwàåñòè @
			cout << endl; // íà÷àòü íîâÓJQ ñòðîêó
		}	// êîíåö âíåøíårî fo r
return 0; // óñïåøíîå sàâåðøåèèå
}// êîíåö main*/
...
/*int main()
{
	for (int count = 1; count <= 10; count++) // ïîâòîðèòü 1 0 ðàç
	{
		if(count == 5)// åñëè count ðàâåí 5 ,
			;// ïðîïóñòèòü îñòàâøèéñÿ êîä öèêëà
		else
			cout << count << " ";
	}// êîíåö for
...
int main()
{
	...
	int oneCentury{ 1000 }; // define  one century variable
